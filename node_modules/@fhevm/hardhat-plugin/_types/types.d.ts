import type { CoprocessorEvent, DecryptionRequestEvent, FhevmContractName, FhevmPublicDecryptOptions, FhevmTypeEuint, FhevmUserDecryptOptions } from "@fhevm/mock-utils";
...
export { FhevmType, FhevmTypeEuint, FhevmUserDecryptOptions, FhevmKeypair, FhevmUserDecryptValidity, } from "@fhevm/mock-utils";
export interface HardhatFhevmRuntimeEnvironment {
    ...
    userDecryptEbool(handleBytes32: string, contractAddress: ethers.AddressLike, user: ethers.Signer, options?: FhevmUserDecryptOptions): Promise<boolean>;
     ...
     * ```
     */
    userDecryptEuint(fhevmType: FhevmTypeEuint, handleBytes32: string, contractAddress: ethers.AddressLike, user: ethers.Signer, options?: FhevmUserDecryptOptions): Promise<bigint>;
    publicDecryptEuint(fhevmType: FhevmTypeEuint, handleBytes32: string, options?: FhevmPublicDecryptOptions): Promise<bigint>;
    userDecryptEaddress(handleBytes32: string, contractAddress: ethers.AddressLike, user: ethers.Signer, options?: FhevmUserDecryptOptions): Promise<string>;
