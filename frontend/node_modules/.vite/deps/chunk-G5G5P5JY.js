...
async function prepareTransactionRequest(client, args) {
  const { account: account_ = client.account, chain, nonceManager: nonceManager2, parameters = defaultParameters } = args;
  let chainId;
  ...
  const attemptFill = (
    ...
    ["fees", "gas"].some((parameter) => {
      var _a;
      return (_a = args.parameters) == null ? void 0 : _a.includes(parameter);
    })
  );
...
@noble/curves/esm/secp256k1.js:
  (*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=chunk-G5G5P5JY.js.map
